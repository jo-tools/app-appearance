...
#tag WindowCode
	#tag Event
		Sub Opening()
		  ...
		  #If (Not TargetMacOS) Then
		    ...
		    Self.MinimumHeight = labChangeTitle.Top + 10
	...
	#tag Constant, Name = kURL_Repository, Type = String, Dynamic = False, Default = \"https://github.com/jo-tools/app-appearance", Scope = Private
	#tag EndConstant
...
#tag Events labAvailability
	#tag Event
		Sub Opening()
		  ...
		  Else
		    Me.Text = "not available"
		    Me.TextColor = &cFB0106
		  End If
		End Sub
	#tag EndEvent
#tag EndEvents
...
#tag Events labContact
	...
	#tag EndEvent
#tag EndEvents
#tag Events timAppearanceRefresh
	#tag Event
		Sub Action()
		  Self.RefreshAppearanceCurrent
		End Sub
	#tag EndEvent
#tag EndEvents
